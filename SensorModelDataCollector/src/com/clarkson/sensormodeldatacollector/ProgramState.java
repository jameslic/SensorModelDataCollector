    ...
    public synchronized void setProgramState(State state) {
        ...
        switch (state) {
            ...
            case STATE_MOVEMENT_START:
                menuManager.setIsMenuVisible(false);
                sketchView.setMessages("com.clarkson.sensormodeldatacollector.Movement:", "Tap on screen for menu");
            ...
            case STATE_MOVEMENT_RESUME:
                if (movement.movementWasStarted()) {
                    ...
                    sketchView.setMessages("ERROR:", "com.clarkson.sensormodeldatacollector.Movement was not started !");
                }
                break;
